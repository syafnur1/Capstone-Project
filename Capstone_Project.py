...
with col1:
   ...
   st.image(image, use_column_width='auto', caption = """Sumber: [Badan Pusat Statistik](https://www.bps.go.id/indicator/16/1150/1/jumlah-kunjungan-wisatawan-mancanegara-per-bulan-ke-indonesia-menurut-pintu-masuk-2017---sekarang.html)""",unsafe_allow_html=True)
