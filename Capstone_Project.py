...
plost.line_chart(df, x='Tahun', y='Jumlah Turis', color='company', legend='top', pan_zoom='minimap', title='Jumlah Turis per Tahun',  x_annot={'2020': "Ini ketika Pandemi Covid melanda Indonesia"},)
